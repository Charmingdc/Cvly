...
export default function ShapeDivider({
  ...
  return (
    <div
      className={`custom-shape-divider-bottom ${className}`}
      aria-hidden='true'
    >
      <svg
        data-name='Layer 1'
      ...
      >
        <path
          ...
          24.88,209.4,13.08,36.15-6,69.85,
          -17.84,104.45-29.34C989.49,25,
        ...
        <path
          ...
          119.13-24.28,37.78-17.59,75.16-39,
          116.92-43.05,59.73-5.85,113.28,
